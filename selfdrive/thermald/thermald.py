...
DAYS_NO_CONNECTIVITY_MAX = 30  # do not allow to engage after 30 days without internet
DAYS_NO_CONNECTIVITY_PROMPT = 21  # send an offroad prompt after 21 days with no internet
